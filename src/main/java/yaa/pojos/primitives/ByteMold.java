...
public class ByteMold {
  public static YaaClz newByte() {
    var clz = new YaaClz(byte$name);
    ...
    var toStringMtd = MoldUtils.toStringMtds(byte$name);
    clz.instanceMethods.put("toString", toStringMtd);
    var hashCodeMtd = MoldUtils.hashCodeMtds(byte$name);
    clz.instanceMethods.put("hashCode", hashCodeMtd);
    var getClassMtd = MoldUtils.getClassMtds(byte$name);
    clz.instanceMethods.put("getClass", getClassMtd);

    var box$fun = new YaaFun("box");
    box$fun.type = new YaaClz("java.lang.Byte");
  ...
  private static MtdPack rootMtds() {
    ...
    right$Byte.type = new YaaClz(byte$name);
  ...
  private static YaaFun new$fun(String mtd$name) {
    return new YaaFun(mtd$name, byte$name);
  }
}
