...
public class DoubleMold {
  public static YaaClz newDouble() {
    var clz = new YaaClz(double$name);
    ...
    var toStringMtd = MoldUtils.toStringMtds(double$name);
    clz.instanceMethods.put("toString", toStringMtd);
    var hashCodeMtd = MoldUtils.hashCodeMtds(double$name);
    clz.instanceMethods.put("hashCode", hashCodeMtd);
    var getClassMtd = MoldUtils.getClassMtds(double$name);
    clz.instanceMethods.put("getClass", getClassMtd);

    var box$fun = new YaaFun("box");
    box$fun.type = new YaaClz("java.lang.Double");
  ...
  private static MtdPack unaryPlus() {
    ...
    mtd$list.type = new YaaClz(double$name);
  ...
  private static YaaFun new$fun(String mtd$name) {
    return new YaaFun(mtd$name, double$name);
  }
}